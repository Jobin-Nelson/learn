...
Qn: Given an array of strings words and a width maxWidth, format the text such
...
Notes:
    - no dsa involved just write clean code
'''
...
if __name__ == '__main__':
    w1, m1 = ["This", "is", "an", "example", "of", "text", "justification."], 16
    w2, m2 = ["What","must","be","acknowledgment","shall","be"], 16
    w3, m3 = ["Science","is","what","we","understand","well","enough","to","explain","to","a","computer.","Art","is","everything","else","we","do"], 20

    print(fullJustify(w1, m1))
    print(fullJustify(w2, m2))
    print(fullJustify(w3, m3))
