...
Qn: In the world of Dota2, there are two parties: the Radiant and the Dire.
...
if __name__ == '__main__':
    ...
    print(predictPartyVictory(s1))
    print(predictPartyVictory(s2))
